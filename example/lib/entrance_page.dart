...
class _EntrancePageState extends State<EntrancePage> {
  ...
  void initState() {
    ...
    voIPKit.onDidRejectIncomingCall = (
      ...
      print('🎈 EntrancePage.onDidRejectIncomingCall: $channelId, $callerId');
    ...
    voIPKit.onDidAcceptIncomingCall = (
      ...
      print('🎈 EntrancePage.onDidAcceptIncomingCall: $channelId, $callerId');
  ...
  void _onIncomingCall(
    ...
    print(
      '🎈 EntrancePage._onIncomingCall: $rtcChannelId, $callerPeerId, $callerName',
    );
